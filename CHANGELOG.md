...
- A local pre-attach verifier recomputes the confirmed resume fingerprint, validates its run and expiration, and locks the exact file read-only immediately before browser attachment.
