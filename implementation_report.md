...
- Bumped `trackly-cli` to `0.6.4`, the bundled Trackly Apply skill to `2.3.0`, and the shared Apply tool contract to `2.1.0`.
...
- Existing managed skill `2.2.0` installs become stale and are upgraded by `trackly agent setup` to `2.3.0`.
